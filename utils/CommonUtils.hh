...
*   password is considered INVALID if it contains a character that does not
*   satisfy conditions 1, 2, 3 or 5.
*
**/
...
*   characters defined in Task 3. The string will be of random length between 6
